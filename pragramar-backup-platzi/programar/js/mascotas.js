...
// const mascotaEnemigo = document.getElementById('mascota-ataqueEnemigo');
...
// NO PONER EL SCRIPT AL FINALIZAR EL BODY
    ...
    // parrafo.innerHTML = "Tu mascota ataco con " + ataqueJugador + ", y la mascota de tu ataqueEnemigo ataco con " + ataqueEnemigo + " - " + resultado;
